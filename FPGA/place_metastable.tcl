...
while {$i < $n_inverters} {
	...
	if {$i < [expr $n_inverters-1]} {
		...
		set next_site_name "R2C2A"
	}
	
	puts "aggiungendo inv_connections_${i} $next_site_name"
	eco_add net -name "inv_connections_${i}" -netpin "${siteName}.F1" -netpin "${next_site_name}.A1"
...
eco_add netpin -net "response_from_metastable_c" -netpin "R2C2A.Q1"
